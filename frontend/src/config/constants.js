...
export const GATES = {
  ...
  QFT:     { type: 'QFT',     label: 'QFT',       symbol: 'QFT',  tone: 'violet',  qubits: 2, angle: false, block: true, desc: 'Quantum Fourier Transform block (H, controlled-phase, swap) on the two qubits it spans' },
  IQFT:    { type: 'IQFT',    label: 'Inverse QFT', symbol: 'QFT†', tone: 'violet', qubits: 2, angle: false, block: true, desc: 'Inverse Quantum Fourier Transform block on the two qubits it spans' },
